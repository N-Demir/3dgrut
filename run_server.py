...
def launch_ssh_server(q: modal.Queue):
    ...
    if hello_world:
        ...
        with modal.Queue.ephemeral() as q:
            ...
            try:
                ...
                # TODO: This is a great idea, but for some reason it's buggy
                # print("Opening up a cursor window...")
                # subprocess.run("cursor --remote ssh://modal-server /workspace/", shell=True)
